...
<div id="transref">
	<div align="center"><strong>Enter Locator No. for New Student / Student ID for Old Student:</strong>	  
	  <input type="text" value="" maxlength="20" size="10" name="locno" id="locno" style="text-align:center"></div><div>&nbsp;</div>
	<div align="center"><strong>Enter Sent Generated Transaction Reference No. :</strong>	  <input type="text" value="" maxlength="20" size="10" name="gtrn" id="gtrn" style="text-align:center"></div>
