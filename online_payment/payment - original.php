...
<script>
	...
	if (ind=="1")	{document.getElementById("isdesc").value=1;}		
	}
	   ...
	   <table width="100%" border="0" cellpadding="10" cellspacing="10" align="center">		  
		   ...
		   <tr>
			 ...
			 <td>
				...
				?><input type="text" name="description" id="description" readonly style="padding: 10px; font-size: 14px; background-color: #97ECE3" size="128" maxlength="128" required><br><span style="font-size: 12px">( Please select from Particulars )</span><br>
...
<select name="sem" id="sem" style="padding: 10px; font-size: 14px" onChange="updatedesc('0')">
		  ...
		  <td><input type="text" name="payee_name" id="payee_name" style="padding: 10px; font-size: 14px" size="80" maxlength="80" required  onChange="updatedesc('0')"  value="<?php if (isset($_GET["payee"])) {echo $_GET["payee"];} ?>" <?php if (isset($_GET["payee"])) {echo " readonly ";}?>></td>
	      </tr> 
		</table>		
