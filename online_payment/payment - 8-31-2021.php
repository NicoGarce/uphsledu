		   ...
		   <tr>
			 ...
			 <td>
				...
				?><input type="text" name="description" id="description" <?php if (trim($_GET["payee"])!="") { ?> readonly <?php } ?> style="padding: 10px; font-size: 14px; background-color: #97ECE3" size="128" maxlength="128" required><br><span style="font-size: 12px">
				 ...
				 <?php if (trim($_GET["payee"])=="") {echo "( Please select payment particulars/description below, <lable style='color:red'>if not on list, please enter the description of the payment you will be paying for</lable>)";} else {echo "( Please select from Particulars )";} ?>
...
<?php } // if payee is blank ?>
		  ...
		  <td><input type="text" name="payee_name" id="payee_name" style="padding: 10px; font-size: 14px" size="80" maxlength="80" required></td>
