...
if (isSectionInMaintenance('online-payment', 'guest') || isSectionInMaintenance('online-payment')) {
...
if (!isset($_SESSION['isin'])) {
    echo "<div>&nbsp;</div><div>&nbsp;</div><a href='guest.php'><div style='font-weight:bold; font-size:20px;' align='center'>Click here to go to homepage and select your campus</div></a>";
    die;
} 
}
...
<script>
	...
	if (ind=="0")	{	
	   ...
	   document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" ("+document.getElementById("locno").value+") >> "+document.getElementById("descselect").value+", "+document.getElementById("syfrom").value+", "+document.getElementById("sem").value;
	...
	if (ind=="2")	{	
	   ...
	   document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" ("+document.getElementById("locno").value+") >> "+tempdesc;
	...
	if (ind=="1")	{
		 document.getElementById("description").value="";
   if ( (document.getElementById("desc_others").value).trim() != "" ) {
	     document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" ("+document.getElementById("locno").value+") >> "+document.getElementById("desc_others").value+", "+document.getElementById("syfrom").value+", "+document.getElementById("sem").value;
	   } else {
	     document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" ("+document.getElementById("locno").value+") >> "+document.getElementById("descselect").value+", "+document.getElementById("syfrom").value+", "+document.getElementById("sem").value;
	   }
...
?>
				    ...
				    <option values='ACTIVITY FEE'>ACTIVITY FEE</option>
					 ...
					 <option values='COMMUNITY OUTREACH PROGRAM'>COMMUNIT OUTREACH PROGRAM</option>

					 <option values='COMPLETION FORM'>COMPLETION FORM</option>
					 <option values='COPY OF GRADES'>COPY OF GRADES</option>
					 ...
					 <option values='GOOD MORAL'>GOOD MORAL</option>
...
<?php } // if payee is blank ?>
		  ...
		  <input type="text" name="locno" id="locno" value="<?php echo $_GET["locno"];  ?>" readonly="true" style="background-color:blue; color:white; text-align:center; font-weigth:bold">
