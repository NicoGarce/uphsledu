...
define('MERCHANT_ID', 'UOPHSLI');
define('MERCHANT_PASSWORD', 'KVdi4JZZnKgndBJ');
	   ...
	   <table width="100%" border="0" cellpadding="10" cellspacing="10" align="center">		  
		   ...
		   <tr>
			 ...
			 <td>
				...
				?><input type="text" name="description" id="description" readonly style="padding: 10px; font-size: 14px" size="128" maxlength="128"><br>	   				   
				   Type: <select name="descselect" id="descselect" required style="padding: 10px; font-size: 14px" onChange="updatedesc()">
				 ...
				 For School Year: <select name="syfrom" id="syfrom" style="padding: 10px; font-size: 14px" onChange="updatedesc()">
				 <?php $d=date("Y"); while ($d>=1980) {$c=$d+1; ?> 
				  <option value="<?php echo $d."-".$c;?>"><?php echo $d."-".$c;?></option>
				 <?php $d=$d-1; } ?> 
				  </select><br>For Semester: <select name="sem" id="sem" style="padding: 10px; font-size: 14px" onChange="updatedesc()">
