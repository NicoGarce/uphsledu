...
<script>
   ...
   if ( (document.getElementById("desc_others").value).trim() != "" ) {
	     document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" >> "+document.getElementById("desc_others").value+", "+document.getElementById("syfrom").value+", "+document.getElementById("sem").value;
	   } else {
	     document.getElementById("description").value=(document.getElementById("payee_name").value).toUpperCase()+" >> "+document.getElementById("descselect").value+", "+document.getElementById("syfrom").value+", "+document.getElementById("sem").value;
	   }
	   ...
	   <table width="100%" border="0" cellpadding="10" cellspacing="10" align="center">		  
		   ...
		   <tr>
			 ...
			 <td>
				...
				?><input type="hidden" name="description" id="description" placeholder="Auto-filled" readonly="true" style="padding: 10px; font-size: 14px; background-color: #97ECE3" size="128" maxlength="128" required>
...
?>
				...
				<span style="font-size: 12px">
				 ...
				 <?php if (trim($_GET["payee"])=="") {echo "( Please select payment particulars/description below )";} else {echo "( Please select from Particulars )";} ?>
				    ...
				    <br><label style="color:blue">or if not on list,
						<input type="text" name="desc_others" id="desc_others" placeholder=" enter here "> 
						the description of the payment you will be paying for</label>
