...
include "dbconnect.php";
 if (isset($_POST["btnsubmit"])) {
	...
	?>
	 <div style="padding:20px; background-color:#FF0000; color:#FFFFFF; font-size:40px; font-weight:bold" align="center">Entered transaction reference no. does<br>not exist or is not validated</div>
<?php	
	 }
    die;
 }
