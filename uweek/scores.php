...
$shareUrl = ($shareSlug !== '') ? ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] . $base_path . 'uweek/scores.php?e=' . urlencode($shareSlug)) : ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' ? 'https://' : 'http://') . ($_SERVER['HTTP_HOST'] ?? '') . $base_path . 'uweek/scores.php');
...
<div class="uweek-subnav" aria-label="Section navigation">
  <a href="<?php echo $base_path; ?>uweek/">Overview</a>
  <a href="<?php echo $base_path; ?>uweek/scores.php" class="active">Brackets</a>
