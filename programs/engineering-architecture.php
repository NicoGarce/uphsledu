...
if (isSectionInMaintenance('programs', 'engineering-architecture') || isSectionInMaintenance('programs')) {
    $page_title = "Engineering & Architecture - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'engineering-architecture')) {
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="content-main">
                    ...
                    <?php
                    $category = getCategoryByName('Engineering & Architecture');
                    $categoryId = $category ? $category['id'] : null;
                    $sectionTitle = 'Engineering & Architecture News & Updates';
                    $sectionDescription = 'Stay updated with the latest news and announcements from the College of Engineering & Architecture.';
