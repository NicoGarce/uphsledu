<?php
/**
 * UPHSL Education Program Page
 * 
 * @author Nico Roell D. Garce
 * @title UPHSL Web Administrator 2025
 * @description Information about the Education program at UPHSL
 */
...
if (isSectionInMaintenance('programs', 'education') || isSectionInMaintenance('programs')) {
    $page_title = "Education - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'education')) {
...
$bg_image = 'img/banner/TEACHER EDUCATION.jpg';
    ...
    <section class="page-header" style="background-image: url('<?php echo $bg_image; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="container">
            <div class="banner-logo">
                <img src="<?php echo $base_path; ?>programs/img/logo/uphsl-educ-logo.png" alt="Teacher Education Logo">
            </div>
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="content-main">
                    ...
                    $sectionTitle = 'Education News & Updates';
                    $sectionDescription = 'Stay updated with the latest news and announcements from the College of Education.';
