...
if (isSectionInMaintenance('programs', 'law') || isSectionInMaintenance('programs')) {
    $page_title = "Law/Juris Doctor - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'law')) {
