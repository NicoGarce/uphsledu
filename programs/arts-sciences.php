...
if (isSectionInMaintenance('programs', 'arts-sciences') || isSectionInMaintenance('programs')) {
    $page_title = "Arts & Sciences - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'arts-sciences')) {
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="content-main">
                    ...
                    <?php
                    $category = getCategoryByName('Arts & Sciences');
                    $categoryId = $category ? $category['id'] : null;
                    $sectionTitle = 'Arts & Sciences News & Updates';
                    $sectionDescription = 'Stay updated with the latest news and announcements from the College of Arts & Sciences.';
                    ...
                    <article class="content-article">
                        ...
                        <section class="mission-vision-section">
                            ...
                            <div class="history-content">
                                ...
                                <p>In alignment with the university's quality assurance initiatives, CAS contributed to the successful attainment and maintenance of ISO 9001:2015 certification, ensuring that administrative and academic support processes meet international quality management standards.</p>
                                
                                <p>CAS has also taken part in the QS Stars Rating System, supporting the university's achievement of high scores in areas such as teaching, employability, and inclusiveness. The college's innovative curriculum, competent faculty, and student support systems have been instrumental in boosting the university's QS performance.</p>
                                
                                <p>Furthermore, CAS played a significant role in fulfilling the university's requirements for the Times Higher Education (THE) Impact Rankings, particularly in key United Nations Sustainable Development Goals (SDGs) such as Quality Education, Gender Equality, and Climate Action. Faculty-led community extension programs, sustainability research, and interdisciplinary collaborations were central to this recognition.</p>
                                
                                <p>The college is also engaged in initiatives aligned with AppliedHE, a rising global rating and ranking platform that focuses on teaching and learning quality, graduate employability, and internationalization. CAS has contributed to the university's standing through its student-centered pedagogy, international research publications, and growing global linkages.</p>
                                ...
                                <p>The Liberal Arts programs (AB Psychology, AB Communication Arts, AB Political Science) of the College were accredited Level IV by the Philippines Association of Colleges and Universities-Commission on Accreditation (PACUCOA) for the period of January 2021 to November 2026. Bachelor of Science in Psychology was granted Level III accreditation status in October 2024 to October 2029.</p>
                            </div>
                        </section>
