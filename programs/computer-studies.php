...
if (isSectionInMaintenance('programs', 'computer-studies') || isSectionInMaintenance('programs')) {
    $page_title = "Computer Studies - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'computer-studies')) {
...
$bg_image = 'img/banner/COMPUTER STUDIES.jpg';
    ...
    <section class="page-header" style="background-image: url('<?php echo $bg_image; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="container">
            <div class="banner-logo">
                <img src="<?php echo $base_path; ?>programs/img/logo/CCS-Logo.png" alt="Computer Studies Logo">
            </div>
