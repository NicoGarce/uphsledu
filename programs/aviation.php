...
if (isSectionInMaintenance('programs', 'aviation') || isSectionInMaintenance('programs')) {
    $page_title = "Aviation - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'aviation')) {
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="content-main">
                    ...
                    <?php
                    $category = getCategoryByName('Aviation');
                    $categoryId = $category ? $category['id'] : null;
                    $sectionTitle = 'Aviation News & Updates';
                    $sectionDescription = 'Stay updated with the latest news and announcements from the School of Aviation.';
