...
if (isSectionInMaintenance('programs', 'business-accountancy') || isSectionInMaintenance('programs')) {
    $page_title = "Business & Accountancy - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'business-accountancy')) {
