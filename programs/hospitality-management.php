<?php
/**
 * UPHSL Hospitality Management Program Page
 * 
 * @author Nico Roell D. Garce
 * @title UPHSL Web Administrator 2025
 * @description Information about the Hospitality Management program at UPHSL
 */
...
if (isSectionInMaintenance('programs', 'hospitality-management') || isSectionInMaintenance('programs')) {
    $page_title = "International Hospitality Management - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('programs', $base_path, 'hospitality-management')) {
    ...
    <section class="page-header" style="background-image: url('<?php echo $bg_image; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="container">
            <div class="banner-logo">
                <img src="<?php echo $base_path; ?>programs/img/logo/uphsl-cihm-logo.png" alt="Hospitality Management Logo">
            </div>
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="content-main">
                    ...
                    <?php
                    $category = getCategoryByName('International Hospitality Management');
                    $categoryId = $category ? $category['id'] : null;
                    $sectionTitle = 'International Hospitality Management News & Updates';
                    $sectionDescription = 'Stay updated with the latest news and announcements from the College of International Hospitality Management.';
