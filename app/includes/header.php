...
$navbar_items_config = [
    ...
    'support-services' => [
        ...
        'research' => 'Research and Development Center'
    ],
    'about' => [
        'about-us' => 'About Us',
        'contact' => 'Contact Us',
        ...
        <a href="<?php echo $base_path; ?>">
            ...
            <div class="nav-content">
                ...
                <div class="nav-menu" id="nav-menu">
                    ...
                    <?php endif; ?>
                    <?php if (isNavbarItemVisible('uweek') && getSetting('uweek_enabled','1') === '1'): ?>
                    <div class="nav-item dropdown">
                        <a href="<?php echo $base_path; ?>uweek/" class="nav-link dropdown-toggle <?php echo (strpos($_SERVER['REQUEST_URI'], 'uweek') !== false) ? 'active' : ''; ?>">U-Week <i class="fas fa-chevron-down desktop-chevron"></i></a>
                        <div class="dropdown-menu">
                            <?php 
                            $uweek_subitems = isset($navbar_items_config['uweek']) ? $navbar_items_config['uweek'] : [];
                            if (areAllNavbarSubItemsDisabled('uweek', $uweek_subitems)): ?>
                                <div class="dropdown-placeholder">
                                    <span class="dropdown-placeholder-text">No U-Week pages available at this time.</span>
                                </div>
                            <?php else: ?>
                                <?php if (isNavbarItemVisible('uweek', 'overview')): ?>
                                <a href="<?php echo $base_path; ?>uweek/scores.php" class="dropdown-link <?php echo (strpos($_SERVER['REQUEST_URI'], 'scores.php') !== false) ? 'active' : ''; ?>">Overview</a>
                                <?php endif; ?>
                                <?php if (isNavbarItemVisible('uweek', 'brackets')): ?>
                                <a href="<?php echo $base_path; ?>uweek/" class="dropdown-link <?php echo (strpos($_SERVER['REQUEST_URI'], 'uweek') !== false && strpos($_SERVER['REQUEST_URI'], 'scores.php') === false && strpos($_SERVER['REQUEST_URI'], 'schedules') === false) ? 'active' : ''; ?>">Brackets</a>
                                <?php endif; ?>
    ...
    <div class="mobile-sidebar" id="mobile-sidebar">
        ...
        <nav class="mobile-sidebar-menu">
            ...
            <div class="mobile-nav-item mobile-dropdown">
                <a href="<?php echo $base_path; ?>uweek/" class="mobile-nav-link mobile-dropdown-toggle <?php echo (strpos($_SERVER['REQUEST_URI'], 'uweek') !== false) ? 'active' : ''; ?>">U-Week <i class="fas fa-chevron-down mobile-chevron"></i></a>
                <div class="mobile-dropdown-menu">
                    ...
                    <?php else: ?>
                        <?php if (isNavbarItemVisible('uweek', 'overview')): ?>
                        <a href="<?php echo $base_path; ?>uweek/scores.php" class="mobile-dropdown-link <?php echo (strpos($_SERVER['REQUEST_URI'], 'scores.php') !== false) ? 'active' : ''; ?>">Overview</a>
                        <?php endif; ?>
                        <?php if (isNavbarItemVisible('uweek', 'brackets')): ?>
                        <a href="<?php echo $base_path; ?>uweek/" class="mobile-dropdown-link <?php echo (strpos($_SERVER['REQUEST_URI'], 'uweek') !== false && strpos($_SERVER['REQUEST_URI'], 'scores.php') === false && strpos($_SERVER['REQUEST_URI'], 'schedules') === false) ? 'active' : ''; ?>">Brackets</a>
                        <?php endif; ?>
                        <?php if (isNavbarItemVisible('uweek', 'schedules')): ?>
