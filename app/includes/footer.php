            ...
            <div class="footer-content">
                ...
                <div class="footer-section university-info">
                    <div class="footer-logo-section">
                        <img src="<?php echo $base_path; ?>assets/images/Logos/2026_Logo.png" alt="University of Perpetual Help System" class="footer-logo">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="https://lmsbinan.uphsl.edu.ph/" target="_blank" class="service-link">
                            <i class="fas fa-book"></i>
                            Moodle for College
                        </a></li>
