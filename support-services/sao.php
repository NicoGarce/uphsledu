<?php
/**
 * UPHSL Student Affairs Office Page
 * 
 * @author Nico Roell D. Garce
 * @title UPHSL Web Administrator 2025
 * @description Information about Student Affairs Office and guidance programs at UPHSL
 */
session_start();
...
if (isSectionInMaintenance('support-services', 'sao') || isSectionInMaintenance('support-services')) {
    $page_title = "Student Affairs Office - Maintenance";
    $base_path = '../';
    include '../app/includes/header.php';
    if (displaySectionMaintenance('support-services', $base_path, 'sao')) {
        include '../app/includes/footer.php';
        exit;
    }
}

$page_title = "Student Affairs Office - UPHSL";
$base_path = '../';
...
<main class="main-content">
    ...
    <?php
    $categoryId = 'Student Affairs Office'; // Pass category name, component will look it up
    $sectionTitle = 'Student Affairs Office News & Updates';
    $sectionDescription = 'Stay updated with the latest news and announcements from Student Affairs Office.';
            ...
            <div class="admission-discipline-container">
                ...
                <div class="admission-section" id="admission">
                    ...
                    <div class="admission-notice">
                        ...
                        <p>ALL students who have yet to submit their admission credentials may swing by the SAO Office first for appropriate instructions.</p>
                    </div>
                </div>
            ...
            <div class="handbook-section">
                ...
                <div class="handbook-container">
                    <div class="handbook-image-container">
                        <img src="<?php echo $base_path; ?>assets/images/sao/Handbook.png" alt="Handbook 2023" class="handbook-image">
                        <h4 class="handbook-title">Handbook 2023</h4>
                        <a href="<?php echo $base_path; ?>support-services/sao/Handbook 2023.pdf" target="_blank" class="handbook-download-btn">
    ...
    <section class="content-section evaluation-section">
        <div class="container">
            ...
            <div class="evaluation-notice">
                <p>A hard copy of the ESDO approved concept paper is a pre-requisite for the Google form evaluation link from SAO.</p>
            </div>
        </div>
    </section>
</main>
